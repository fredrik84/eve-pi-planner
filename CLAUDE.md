...
| [docs/production-workflow.md](docs/production-workflow.md) | shared Reactions/Manufacturing behavior contracts and their intentional differences |
| [docs/production-phases-test-protocol.md](docs/production-phases-test-protocol.md) | Phase 5 scope and the click-by-click acceptance protocol for Phases 1–5 across Reactions and Manufacturing |
