# eve-pi-planner — Industry tab

Everything behind the `industry` feature flag: make-or-buy planning, per-component overrides,
customer build-status links, first-use flow, and running a build. Read this before touching the
Industry tab. Back to [CLAUDE.md](../CLAUDE.md).
