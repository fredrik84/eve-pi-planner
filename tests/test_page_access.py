...
Seeds real rows and cleans up after itself, same approach as tests/test_skill_enough.py.
Run inside the container:
    docker exec eve-pi-planner-web-1 python3 tests/test_page_access.py
"""
