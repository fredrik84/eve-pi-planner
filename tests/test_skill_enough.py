...
Seeds real rows + a fabricated pp_sessions cookie, same approach as tests/test_alerts.py.
Run inside the container:
    docker exec eve-pi-planner-web-1 python3 tests/test_skill_enough.py --url http://localhost:8000
"""
